...
const typeNum = (arr) => {
  // Solution code here...
  let newArr = arr.filter(val => !isNaN(val));
  return newArr;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  let newArr =arr.filter(val => val.includes('and'));
  return newArr;
};
...
const oddValues = (arr) => {
  // Solution code here...
  let newArr = arr.filter(val => val%2===1);
  return newArr;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let newArr = arr.filter(val => !(forbiddenValues.includes(val)));
  return newArr;
};
