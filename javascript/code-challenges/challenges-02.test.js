...
const raisedToTheThird = (arr) => {
  // Solution code here...
  let newArr = arr.map( val => Math.pow(val,3));
  return newArr;
};
...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  let newArr = [];
  arr.forEach( val => newArr.push(Math.pow(2,val)));
  return newArr;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let newArr = arr.map( val => Math.pow(2,val));
  return newArr;
};
...
const charCode = (arr) => {
  // Solution code here...
  let newArr = arr.map( (val) => val.charCodeAt(0));
  return newArr;
};
